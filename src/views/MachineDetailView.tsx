...
export function MachineDetailView({
  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-white text-gray-900">
      <section className="relative bg-white pb-6 pt-20 sm:pb-10 sm:pt-24 lg:pb-16 lg:pt-32">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mt-6 grid gap-6 sm:mt-8 lg:grid-cols-2 lg:gap-10">
            {/* Image Carousel */}
            <Reveal animation="scale-in" className="space-y-3">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-gray-100 shadow-lg lg:rounded-2xl">
                ...
                {images.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-3 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-gray-900 shadow-md backdrop-blur-sm transition-all hover:scale-105 active:scale-95 lg:h-11 lg:w-11"
                    ...
                    <button
                      onClick={goToNext}
                      className="absolute right-3 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-gray-900 shadow-md backdrop-blur-sm transition-all hover:scale-105 active:scale-95 lg:h-11 lg:w-11"
                    ...
                    {/* Image Counter */}
                    <div className="absolute bottom-3 right-3 rounded-full bg-black/75 px-2.5 py-1 text-xs font-semibold text-white backdrop-blur-sm">
                ...
                >
                  {images.map((image, index) => (
                    <button
                      ...
                      className={`relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg border-2 transition-all lg:h-20 lg:w-20 ${
              ...
              <Reveal animation="fade-up" delay={150}>
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[hsl(var(--primary))]/10 sm:h-10 sm:w-10">
                    ...
                    <div className="flex flex-col gap-2.5 sm:flex-row">
                      ...
                      >
                        ...
                        >
                          ...
                          <span>Ring {machine.dealer.phone}</span>
                        </a>
                      </Button>
                      <Button
                        asChild
      ...
      <section className="bg-gray-50 py-10 sm:py-14 lg:py-20">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
              ...
              <Card className="h-full border-0 bg-white shadow-lg">
                <CardContent className="p-5 sm:p-6">
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-1 w-8 bg-[hsl(var(--primary))]" />
          ...
          <Reveal animation="fade-up" delay={150}>
            <Card className="mt-6 border border-blue-200 bg-blue-50 shadow-lg">
              <CardContent className="p-5 sm:p-6">
                <div className="mb-3 flex items-start gap-3">
                  <div className="mt-1.5 h-1 w-8 flex-shrink-0 bg-blue-500" />
